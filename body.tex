...
%Therefore the version identification defined in the following \ref{sec:versioning}, is not sufficient to identify the binary package. The build number shall be considered also.
